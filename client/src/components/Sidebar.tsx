...
import { 
  ...
  UserCheck, Database, LogIn, Shield, Sparkles, ChevronDown
} from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside
      className={`h-full bg-[#070c18] text-slate-300 flex flex-col border-r border-slate-800/80 transition-all duration-300 relative z-30 shrink-0 select-none ${
        collapsed ? 'w-16' : 'w-64'
      }`}
    >
      {/* Brand Header */}
      <div className="h-16 px-4 flex items-center justify-between border-b border-slate-800/80 shrink-0">
        ...
        <button
          ...
          className="p-1.5 rounded-lg text-slate-400 hover:text-white hover:bg-slate-800/70 transition-colors hidden sm:flex items-center justify-center"
